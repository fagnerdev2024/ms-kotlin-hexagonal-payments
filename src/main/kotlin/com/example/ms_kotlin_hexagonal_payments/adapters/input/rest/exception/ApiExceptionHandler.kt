...
class ApiExceptionHandler {
    ...
    fun handleNotFound(ex: NotFoundException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
    ...
    fun handlePaymentNotApprovedForRefund(ex: PaymentNotApprovedForRefundException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val problem = buildProblemDetail(
    ...
    fun handleRefundAmountGreaterThanPayment(ex: RefundAmountGreaterThanPaymentException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val problem = buildProblemDetail(
            status = HttpStatus.UNPROCESSABLE_ENTITY,
    ...
    fun handleBusinessRule(ex: BusinessRuleException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val problem = buildProblemDetail(
            status = HttpStatus.UNPROCESSABLE_ENTITY,
    ...
    fun handleBusiness(ex: BusinessException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val problem = buildProblemDetail(
            status = HttpStatus.UNPROCESSABLE_ENTITY,
    ...
    fun handleValidation(ex: MethodArgumentNotValidException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
    ...
    fun handleTypeMismatch(ex: MethodArgumentTypeMismatchException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val detail = when {
    ...
    fun handleMissingParameter(ex: MissingServletRequestParameterException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val problem = buildProblemDetail(
            status = HttpStatus.BAD_REQUEST,
            title = "Bad Request",
    ...
    fun handleHttpMessageNotReadable(ex: HttpMessageNotReadableException, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
    ...
    fun handleGeneric(ex: Exception, httpServletRequest: HttpServletRequest): ResponseEntity<ProblemDetail> {
        val problem = buildProblemDetail(
    ...
    private fun buildProblemDetail(status: HttpStatus, title: String, detail: String, path: String, type: String): ProblemDetail {
